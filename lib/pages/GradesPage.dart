          ...
          Expanded(
            child: ListView(
              children: [
                ...
                _buildGradeItem("Geography", "78"),
                _buildGradeItem("Chemistry", "85"),
                _buildGradeItem("Physics", "92"),
                _buildGradeItem("Biology", "88"),
                _buildGradeItem("Computer Science", "95"),
                _buildGradeItem("Music", "76"),
                _buildGradeItem("Social Studies", "83"),
                _buildGradeItem("Foreign Language", "89"),
